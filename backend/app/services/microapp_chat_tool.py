    ...
    return {
        ...
        "function": {
            ...
            "description": (
                ...
                "and the app opens/refreshes in the panel. The agent has its "
                "own tools (file read/edit, bash, and web search via its "
                "opencode environment), so PREFER calling this with the user's "
                "request as-is instead of doing preparatory web_search / "
                "web_fetch calls yourself — handing the whole task to the "
                "micro-app agent in one call is faster, keeps the user's "
                "iteration budget free, and guarantees the panel reflects the "
                "result. Examples: 'show me my house', 'add a window to the "
                "living room', 'añade un baño', 'find a better ice-cream near "
                "Templo de Debod and update day 2', 'muéstrame la app de "
