...
| Topic | File |
|-------|------|
| Backend conventions & gotchas | `backend/AGENTS.md` |
| Frontend conventions & gotchas | `lib/AGENTS.md` |
| Deployment ops | `deploy/AGENTS.md`, `deploy/README.md` |
...
Keep these docs current as you work — the policy is in root `AGENTS.md`
