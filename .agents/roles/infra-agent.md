...
1. **Read context first**: Before starting, read `AGENTS.md` to understand infrastructure patterns and constraints.
...
Implement this infrastructure task following the patterns in `AGENTS.md`. After completion:
