...
import 'package:garbanzo_ai/features/chat/widgets/workflow_run_tile.dart';
...
class _ActionProposalCardState extends State<ActionProposalCard> {
  ...
  Widget build(BuildContext context) {
    // delegate_workflow asks nothing of the user — it's already running — so
    // it renders as a quiet expandable line rather than a decision card.
    if (_type == 'delegate_workflow') {
      return WorkflowRunTile(message: widget.message);
    }
