...
mixin _$Conversation {
 ...
 String get id; String? get title; String get model; DateTime get createdAt; DateTime get updatedAt; int get messageCount; bool get useMemory; bool get useKnowledgeBase; bool get isPinned; String? get contextSummary; String? get systemPrompt;@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) ThinkingLevel? get thinkingLevel; List<String>? get enabledTools; List<ChatMessage>? get messages; DateTime? get mutedUntil;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,model,createdAt,updatedAt,messageCount,useMemory,useKnowledgeBase,isPinned,contextSummary,systemPrompt,thinkingLevel,const DeepCollectionEquality().hash(enabledTools),const DeepCollectionEquality().hash(messages),mutedUntil);

@override
String toString() {
  return 'Conversation(id: $id, title: $title, model: $model, createdAt: $createdAt, updatedAt: $updatedAt, messageCount: $messageCount, useMemory: $useMemory, useKnowledgeBase: $useKnowledgeBase, isPinned: $isPinned, contextSummary: $contextSummary, systemPrompt: $systemPrompt, thinkingLevel: $thinkingLevel, enabledTools: $enabledTools, messages: $messages, mutedUntil: $mutedUntil)';
}
...
@useResult
$Res call({
 String id, String? title, String model, DateTime createdAt, DateTime updatedAt, int messageCount, bool useMemory, bool useKnowledgeBase, bool isPinned, String? contextSummary, String? systemPrompt,@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) ThinkingLevel? thinkingLevel, List<String>? enabledTools, List<ChatMessage>? messages, DateTime? mutedUntil
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? title,  String model,  DateTime createdAt,  DateTime updatedAt,  int messageCount,  bool useMemory,  bool useKnowledgeBase,  bool isPinned,  String? contextSummary,  String? systemPrompt, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue)  ThinkingLevel? thinkingLevel,  List<String>? enabledTools,  List<ChatMessage>? messages,  DateTime? mutedUntil)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Conversation() when $default != null:
return $default(_that.id,_that.title,_that.model,_that.createdAt,_that.updatedAt,_that.messageCount,_that.useMemory,_that.useKnowledgeBase,_that.isPinned,_that.contextSummary,_that.systemPrompt,_that.thinkingLevel,_that.enabledTools,_that.messages,_that.mutedUntil);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? title,  String model,  DateTime createdAt,  DateTime updatedAt,  int messageCount,  bool useMemory,  bool useKnowledgeBase,  bool isPinned,  String? contextSummary,  String? systemPrompt, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue)  ThinkingLevel? thinkingLevel,  List<String>? enabledTools,  List<ChatMessage>? messages,  DateTime? mutedUntil)  $default,) {final _that = this;
switch (_that) {
case _Conversation():
return $default(_that.id,_that.title,_that.model,_that.createdAt,_that.updatedAt,_that.messageCount,_that.useMemory,_that.useKnowledgeBase,_that.isPinned,_that.contextSummary,_that.systemPrompt,_that.thinkingLevel,_that.enabledTools,_that.messages,_that.mutedUntil);case _:
  throw StateError('Unexpected subclass');
...
class _Conversation extends Conversation {
  const _Conversation({required this.id, this.title, required this.model, required this.createdAt, required this.updatedAt, this.messageCount = 0, this.useMemory = true, this.useKnowledgeBase = true, this.isPinned = false, this.contextSummary, this.systemPrompt, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) this.thinkingLevel,  List<String>? enabledTools,  List<ChatMessage>? messages, this.mutedUntil}): _enabledTools = enabledTools,_messages = messages,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,model,createdAt,updatedAt,messageCount,useMemory,useKnowledgeBase,isPinned,contextSummary,systemPrompt,thinkingLevel,const DeepCollectionEquality().hash(_enabledTools),const DeepCollectionEquality().hash(_messages),mutedUntil);
