...
mixin _$Conversation {
 ...
 String get id; String? get title; String get model; DateTime get createdAt; DateTime get updatedAt; int get messageCount; bool get useMemory; bool get useKnowledgeBase; bool get isPinned; String? get contextSummary; String? get systemPrompt;@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) ThinkingLevel? get thinkingLevel; List<String>? get enabledTools; List<ChatMessage>? get messages; bool get hasMoreMessages; DateTime? get mutedUntil; bool get isPrimary; String? get activeTopicId; TopicNode? get activeTopic; bool get topicIsPinned; int get contextVersion; int get sessionEpoch;
...
@useResult
$Res call({
 String id, String? title, String model, DateTime createdAt, DateTime updatedAt, int messageCount, bool useMemory, bool useKnowledgeBase, bool isPinned, String? contextSummary, String? systemPrompt,@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) ThinkingLevel? thinkingLevel, List<String>? enabledTools, List<ChatMessage>? messages, bool hasMoreMessages, DateTime? mutedUntil, bool isPrimary, String? activeTopicId, TopicNode? activeTopic, bool topicIsPinned, int contextVersion, int sessionEpoch
});
...
as int,sessionEpoch: null == sessionEpoch ? _self.sessionEpoch : sessionEpoch // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@override@JsonKey() final  int sessionEpoch;
